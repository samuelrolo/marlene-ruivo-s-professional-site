...
import { Mail, MapPin, Instagram, Linkedin, Check, CreditCard, User, Phone } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Contact Details */}
            <div className="bg-card rounded-3xl p-8 shadow-card border border-border/30 space-y-6">
              <a
                href="mailto:marleneruivonutricao@gmail.com"
                className="flex items-center gap-4 p-4 rounded-xl bg-background hover:bg-sage-light/30 transition-colors group"
              >
                <div className="w-12 h-12 rounded-xl bg-sage-light flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                  <Mail className="w-5 h-5 text-sage-dark group-hover:text-primary-foreground" />
                </div>
                <div>
              ...
              <div className="pt-4 border-t border-border">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-12 h-12 rounded-xl bg-sage-light flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
                  >
                    <Instagram className="w-5 h-5 text-sage-dark hover:text-primary-foreground" />
                  </a>
                  <a
                    ...
                    className="w-12 h-12 rounded-xl bg-sage-light flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
                  >
                    <Linkedin className="w-5 h-5 text-sage-dark hover:text-primary-foreground" />
                  </a>
                </div>
              </div>
            </div>
